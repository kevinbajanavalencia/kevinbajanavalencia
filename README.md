...
- **ELIM Belgium Website Project**  
  Real website project developed during my IT internship. I worked on page structure, responsive design, content organization and Git/GitHub workflow.

- **Fedora Django Portfolio Lab**  
  Personal website project with Django, PostgreSQL, Docker Compose, Nginx and Tailwind.

- **Ubuntu Personal Server Lab**  
  Linux server lab with SSH, UFW, Samba, Nginx, Tailscale and basic deployment.
...
**Networking:** IPv4, DNS, VLANs, routing basics  
